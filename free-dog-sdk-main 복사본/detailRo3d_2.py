...
class MyGLWidget(QOpenGLWidget):
    ...
    def paintGL(self):
        ...
        glTranslatef(1+math.cos(np.deg2rad(180)+self.radrol), 0.5+math.sin(np.deg2rad(180)+self.radrol)-2*math.sin(np.deg2rad(180)+self.radpit), 2+2*math.cos(np.deg2rad(180)+self.radpit))# 몸통을 평면으로 들어올리는 변환
...
#==================================================================
        ...
        glTranslatef(1+math.cos(self.radrol), 0.5+math.sin(self.radrol)-2*math.sin(np.deg2rad(180)+self.radpit),  2+2*math.cos(np.deg2rad(180)+self.radpit)) # 몸통을 평면으로 들어올리는 변환
...
#==================================================================
        ...
        glTranslatef(1+math.cos(self.radrol), 0.5+math.sin(self.radrol)-2*math.sin(self.radpit), 2+2*math.cos(self.radpit)) # 몸통을 평면으로 들어올리는 변환
...
#==================================================================
        ...
        glTranslatef(1+math.cos(np.deg2rad(180)+self.radrol), 0.5+math.sin(np.deg2rad(180)+self.radrol)-2*math.sin(self.radpit), 2+2*math.cos(self.radpit)) # 몸통을 평면으로 들어올리는 변환
